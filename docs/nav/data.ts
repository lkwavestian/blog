...
export const NAV_DATA: NavData[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: "https://assets.monica.im/home-web/_next/static/media/monicaLogo.83e0ae18.png",
        title: "Monica（一站式AI助手）",
...

  {
    ...
    items: [
      ...
      {
        icon: "https://avatars.githubusercontent.com/u/20552239?s=200&v=4",
        title: "DvaJS",
        desc: "轻量级应用框架",
        link: "https://dvajs.xiniushu.com/",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Element UI",
        desc: "基于 Vue 2.0，一套为开发者、设计师和产品经理准备的 的桌面端组件库",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: "/icons/less.png",
        title: "Less",
        desc: "扩展了CSS 的功能并提供了更灵活、更强大的样式定义和管理机制",
